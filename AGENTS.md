...
A lightweight single-page application with a clean UI displaying a counter value and two action buttons. The frontend manages local state and provides instant feedback with smooth animations.

No backend required. All counter logic is handled client-side with browser localStorage for optional persistence.
